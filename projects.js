...
const SLOTS = [
  ...
  { slot: 6,  image: null, href: "cv.pdf", newTab: true,
    text: ["ABOUT", "13 YEARS WOMENSWEAR", "SEOUL, KOREA", "", "HANDSOME · LF · SK · F&F", "", "VIEW CV ↗"] },
  { slot: 7,  image: "landing photo/model1.jpg", title: "ai model study", href: "project.html?id=model" },
  { slot: 8,  image: null, href: "cv.pdf", newTab: true,
    text: ["BRANDS", "TOMMY HILFIGER", "VANESSA BRUNO", "CLUB MONACO", "DUVETICA", "", "VIEW CV ↗"] },
  { slot: 9,  image: null, href: "project.html?id=clo3d",
    text: ["SKILLS", "CLO 3D · FIT NEW YORK", "CAD · PATTERN MAKING", "ILLUSTRATOR · PHOTOSHOP", "GENERATIVE AI", "", "VIEW WORK ↗"] },
